...
public abstract class LifecycleTest
{
     ...
     */
    abstract void callRotation();

    /**
     * Performs the call to recreate(), i.e. destroy then create
     */
    abstract void callRecreation();
    ...
    /**
     * Allows to pause the component, calling in order the methods listed in:
     * @see LifecycleTest#testPause()
     */
    public void pauseAndResumeComponent(@NonNull PauseCallback callback)
    {
    ...
    /**
     * Allows to stop the component, calling in order the methods listed in:
     * @see LifecycleTest#testStop()
     */
    public void stopAndStartComponent(@NonNull StopCallback callback)
    {
        callback.beforeStop();
    ...
    /**
     * Allows to destroy the component, calling in order the methods listed in (onDestroy called depending on the boolean parameter):
     * @see LifecycleTest#testDestroy()
     */
    public void destroyComponent(boolean callOnDestroy, @NonNull DestroyCallback callback)
    {
    ...
    /**
     * Allows to rotate the device, calling in order the methods listed in:
     * @see LifecycleTest#testRotation()
     */
    public void rotateDevice(@NonNull RotationCallback callback)
    {
    ...
    /**
     * Allows to recreate the component, calling in order the methods listed in:
     * @see LifecycleTest#testRecreation()
     */
    public void recreateComponent(@NonNull RecreateCallback callback)
    {
    ...
    public void lifecycleTestPause()
    {
        ...
        pauseAndResumeComponent(callback);
    ...
    public void lifecycleTestStop()
    {
        ...
        stopAndStartComponent(callback);
    ...
    public void lifecycleTestDestroyWithOnDestroy()
    {
        ...
        destroyComponent(true, callback);
    ...
    public void lifecycleTestDestroyWithoutOnDestroy()
    {
        ...
        destroyComponent(false, callback);
